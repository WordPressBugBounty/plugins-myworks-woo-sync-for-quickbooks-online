...
class MyWorks_WC_QBO_Sync_QBO_Lib_Session_Handler extends WC_Session {
	protected $_cookie;
	...
	public function __construct() {
		global $wpdb;
		#$this->_cookie = apply_filters( 'mw_wc_qbo_sync_cookie', 'wp_mw_wc_qbo_sync_session_' . COOKIEHASH );
		$this->_table  = $wpdb->prefix . 'mw_wc_qbo_sync_sessions';
		$this->_scg_name  = 'mwqbos_session_id';#wc_session_id
		$this->_scg_p  = 'mw_wc_qbo_sync_';#wc_
	}
	...
	public function set_session_expiration() {
		$this->_session_expiring   = time() + intval( apply_filters( 'mw_wc_qbo_sync_expiring', 60 * 60 * 47 ) );
		$this->_session_expiration = time() + intval( apply_filters( 'mw_wc_qbo_sync_session_expiration', 60 * 60 * 48 ) );
	}
