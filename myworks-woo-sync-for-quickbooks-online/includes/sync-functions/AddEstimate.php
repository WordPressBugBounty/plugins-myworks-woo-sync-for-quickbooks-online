...
if($include_this_function){
	if($this->is_connected()){
		...
		//$this->add_wc_debug_log( 'Reached AddEstimate function', true, true, true );
			...
			if(!$this->check_quickbooks_estimate_get_obj($wc_inv_id,$wc_inv_num)){
				...
				*/
				...
				if ($resp = $estimateService->add($Context, $realm, $estimate)){
					...
					#New
					$this->PushOrderDocument($qbo_est_id,'Estimate',$invoice_data,$cf_map_data,$cfm_iv);
