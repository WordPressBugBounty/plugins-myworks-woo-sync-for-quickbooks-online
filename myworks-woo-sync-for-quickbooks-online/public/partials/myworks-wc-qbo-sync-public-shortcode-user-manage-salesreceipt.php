...
if($qb_customer_id > 0 && ($qrts == 'SalesReceipt' || $qrts == 'Invoice_SalesReceipt' || $qrts == 'All') && !$MSQS_QL->is_plg_lc_p_l() && $MSQS_QL->option_checked('mw_wc_qbo_sync_wam_mng_inv_ed')){
...
<body>
	<div class="invoice_container mw_wsfqo_p_ic">
	  <h2 class="mw_wsfqo_mih2">Manage Sales Receipts</h2>   
